...
const ExperienceContent = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      type: '实习',
      points: [
        '商业化销售支持：针对消费、零售、餐饮等行业	 20+企业客户，深入理解业务痛点，挖掘飞书产品价值，提炼最佳实践，输出30+份客户案例材料，通过“场景化Demo+标杆案例”，构建标准化商业沟通物料，支持商业化团队客户沟通',
        '社媒运营：负责飞书多维表格公众号日常运营，通过挖掘产品创新玩法与模版应用，结合职场热点、效率工具场景、企业协同与数字化管理场景，策划产品传播选题与内容方向，输出16篇高质量推文，提升核心社区用户活跃度与粘性',
        '竞品调研：追踪钉钉、企微等核心竞品市场动态，拆解竞品功能功能优劣势与营销话术，提炼飞书差异化核心优势，为商业化团队提供沟通策略与案例支持',
        'AI行业洞察：定期跟踪大模型、AIGC及AI Agent 等技术发展趋势，整理AI在企业协同工具中的应用场景，输出AI产品与协同办公场景结合的洞察报告，为产品创新传播与商业化方向提供内容支持'
      ],
      cards: [
